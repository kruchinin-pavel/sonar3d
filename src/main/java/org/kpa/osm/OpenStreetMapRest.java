...
public class OpenStreetMapRest {
    private static final Logger logger = LoggerFactory.getLogger(OpenStreetMapRest.class);
    private final BoundingBox bounds;
    private final Map<Long, Way> ways = new HashMap<>();
    private final Map<Long, Node> nodes = new HashMap<>();
    private final String cacheDir;

    public OpenStreetMapRest(Point swPoint, Point nePoint, String cacheDir) {
    ...
    public String getBoundingBoxRequest() {
        List<Relation> riverBanks = filter(bounds, Relation.class,
